...
<<<<<<< HEAD
    <div className="w-full mx-auto lg:px-0 px-6 max-w-[77rem] py-4 mx-auto h-fit px-7  text-[#444444] flex items-center justify-between"> <Link to={'/projects'} className='h-full  gap-[1.06rem] items-center text-[#5A0C91] font-[400] text-[1rem] cursor:pointer hidden md:flex'> <div><img src={back} alt="" /></div>back to projects</Link> 
=======

...
Each School can register as many as 10,000 students on Eko Learn for N5,000 each per year.</p>
    <div className='w-full flex justify-between items-center my-[3rem]'><p className='text-[20.67px] md:text-[2rem] font-[600]'>#5000</p> <button className='bg-[#5A0C91] py-[9.25px] px-[18.5px] md:py-[0.9375rem] md:px-[1.9375rem] text-white rounded-[10px] text-[14.4px] md:text-[24px] font-[500] md:font-[400]'>Subscribe Now</button> </div>

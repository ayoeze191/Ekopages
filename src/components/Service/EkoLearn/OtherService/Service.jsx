...
const Service = ({smallimg, h, p, btntext, bg}) => {
    const classNames = ["font-lato rounded-[9.85058px] p-[23.64px] w-[284px] h-[400px] "]
  return (
    <div className={classNames.join(``)} style={{backgroundColor: `${bg}`}}>
        ...
        <button 
        className = {`${btntext == 'coming soon'?'bg-[#888]':'bg-[#5A0C91]'} rounded-[5px] py-[11.8px] px-[21.23px] md:py-[10.5px] md:px-[20px] text-white text-[1rem]`}>
            {btntext}
        </button>
    </div>
  )

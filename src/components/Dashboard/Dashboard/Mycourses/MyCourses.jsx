    ...
    <div>
      <div className='py-[54px] flex justify-between pr-[78px]'>
        <div className='flex  gap-[1rem] pl-[40px]'>
          <button className='bg-[#174D00] w-[125px] h-[35px] border-solid border-[1px] border-[#888888] text-[#FBFBFB] rounded-[5px]'>
          Pending
          </button>
          <button className='w-[125px] h-[35px] border-solid border-[1px] border-[#888888] rounded-[5px] text-[#888888]'>
          Completed
          </button>
          </div>
          <div className='flex  gap-[1rem] pl-[40px]'>
          <Link className='bg-[#174D00] w-[125px] h-[35px] border-solid border-[1px] text-center border-[#888888] text-[#FBFBFB] rounded-[5px] flex justify-center items-center' to={'/quizes/h'}>
          Take a Quiz
          </Link>
          <div>
              <img src={bell} alt="" />

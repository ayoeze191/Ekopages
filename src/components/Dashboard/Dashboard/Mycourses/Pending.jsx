...
const Pending = () => {
  ...
  return (
    <div className="flex flex-col mx-auto md:grid md:grid-cols-3 gap-[16px] md:px-[16px] flex-1">
        {isLoading?<MoonLoader />:courses.length == 0 ? <div className=' border-t-[#b0ada7] border-t-solid border-t-2 py-[14.2px] px-[17.8px] items-center font-[400] text-[12px] md:text-base font-lato mt-[1rem] text-[#4A4A4A] text-center bg-[#F8F8F8] w-fit mx-auto flex gap-2 md:gap-[17.9px] flex-col' >

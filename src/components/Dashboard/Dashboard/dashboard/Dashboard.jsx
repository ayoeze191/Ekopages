...
const Dashboard = () => {
  return (
    <div  className='px-[3.625rem] py-[3rem] flex-1 border-solid border-[#CDCDCD] border-[1px] border-l-none h-[100%] flex flex-col'>
        ...
        <div className='flex items-center gap-[17.9px] py-0'><div className=''> <img src={clarity_certificate_line} alt="" /></div></div> <p className='text-[1.5rem] font-[500] font-lato text-center md:text-left' >My Courses</p>
        </div>
        <Courses />
        <Orders />
        </div>

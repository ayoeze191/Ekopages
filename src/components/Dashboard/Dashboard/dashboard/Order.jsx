...
const Order = ({name, DateCreated, Paidon, status}) => {
  ...
  return (
    <div className='flex flex-col gap-[8px] md:gap-[0] md:grid md:grid-cols-4 py-[20px] px-[24px] bg-[#F2F0F3] border-solid border-[0.4px] border-[#969696] md:border-0 font-lato rounded-[5px]'>
        ...
        <div className="  md:after:hidden before:content-['Date_Created'] flex justify-between md:table-cell md:before:hidden md:text-left md:border-y-0 py-3 before:text-black bg-white md:bg-[initial] rounded-[3px] md:rounded-[0px] px-[8px] md:px-[0px]">{Paidon}</div>

...
const Options = ({label, text, selected, onclick}) => {
  ...
  return (
    <div className={`${selected?'bg-purple-700 text-white':'bg-white text-[#4A4A4A] '} flex gap-[1rem] py-[1.1rem] px-[4rem] font-lato font-[400] text-[1rem] items-center `} onClick={() => onclick(label)}>

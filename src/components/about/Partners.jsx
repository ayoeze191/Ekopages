    ...
    <div className='section py-12 mx-auto lg:px-0 px-6 font-lato font-bold '>
      {/* <div className=''><img src={partners} /></div> */}
        ...
        <div className=' flex flex-col sm:flex-row gap-10  md:gap-14 w-full md:w-fit justify-between items-center mx-auto'>
            <div className='px-3 w-full max-w-xs '><img src={British} className='mx-auto md:w-full'/></div>
            <div className='px-3 w-full max-w-xs'><img src={chevening} className='mx-auto md:w-full' /></div>
            <div className='px-3 w-full max-w-xs'><img src={TNCI} className='mx-auto md:w-full' /></div>
            <div className='px-3 w-full max-w-xs'><img src={FME} className='mx-auto md:w-full' /></div>
            <div className='px-3 w-full max-w-xs'><img src={REESAfricaLogo} className='mx-auto md:w-full' /></div>
            <div className='px-3 w-full max-w-xs'><img src={LME} className='mx-auto md:w-full' /></div>
        </div>
        </div>

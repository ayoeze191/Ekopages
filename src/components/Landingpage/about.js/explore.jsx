...
export const Explore = () => {
    const services = [
        {
            title: "Eko learn",
            Icons: <img style={{width: "32px",height: "32px"}} src={assets.ekoLearn}/>,
        ...
        {
            title: "Eko Tales",
            Icons: <img style={{width: "32px",height: "32px"}} src={assets.ekoTale}/>,
        ...
        },
        {
            ...
            Icons: <img style={{width: "32px",height: "32px"}} src={assets.sdgDrive}/>,
        ...
        {
            title: "Book a Tutor",
            Icons: <img style={{width: "32px",height: "32px"}} src={assets.tutor}/>,
    ...
    return (<div className="font-lato w-[100%] text-center mt-[30px]">

        <p  className="font-[700] text-[44px] m-[0px] p-[0px]" > Explore our Services</p>
        <p className="text-[20px] font-[400] text-[#4A4A4A] m-[0px] p-[0px]  mb-[15px] ">Tap into our vault of resources to get the best Black-themed SDG themed books for children. </p>

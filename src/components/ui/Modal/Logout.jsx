...
const Logout = ({sidebarHandler, sidebar}) => {
  ...
  return (
    ...
    <div className=' flex flex-col gap-[24px] md:gap-[66px] items-center text-center py-[87px] md:py-[116px]'>
            ...
            <button className='bg-[#5A0C91] rounded-[5px] w-[120px] h-[40px] text-white font-lato font-medium leading-[19px]' onClick={() => {logout(); setLogOutModal();
        if(sidebar == true){
          sidebarHandler()
        }
            } }>Logout</button> 
